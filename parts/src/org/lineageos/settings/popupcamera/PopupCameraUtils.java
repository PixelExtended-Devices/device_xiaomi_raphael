...
public class PopupCameraUtils {
  ...
  protected static void startService(Context context) {
    ...
    pm.setComponentEnabledSetting(new ComponentName(context, PopupCameraSettingsActivity.class),
  ...
  protected static void stopService(Context context) {
    ...
    context.stopServiceAsUser(new Intent(context, PopupCameraService.class), UserHandle.CURRENT);
    PackageManager pm = context.getPackageManager();
    pm.setComponentEnabledSetting(new ComponentName(context, PopupCameraSettingsActivity.class),
