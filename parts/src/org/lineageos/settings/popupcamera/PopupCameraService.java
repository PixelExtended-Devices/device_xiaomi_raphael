      ...
      new CameraManager.AvailabilityCallback() {
        ...
        public void onCameraClosed(@NonNull String cameraId) {
          ...
          if (cameraId.equals(Constants.FRONT_CAMERA_ID)) {
            ...
            if (SystemClock.elapsedRealtime() - mOpenEvent < Constants.CAMERA_EVENT_DELAY_TIME
        ...
        public void onCameraOpened(@NonNull String cameraId, @NonNull String packageId) {
          ...
          if (cameraId.equals(Constants.FRONT_CAMERA_ID)) {
            ...
            if (SystemClock.elapsedRealtime() - mClosedEvent < Constants.CAMERA_EVENT_DELAY_TIME
    ...
    if (mMotor == null) {
      try {
        ...
        if (mMotor != null) {
          ...
          mMotor.asBinder().linkToDeath((cookie) -> { mMotor = null; }, 0);
        }
      } catch (RemoteException e) {
        // Do nothing
      }
    ...
    mHandler.post(() -> {
      Toast
          .makeText(PopupCameraService.this,
              status == Constants.MOTOR_STATUS_CALIB_OK ? R.string.popup_camera_calibrate_success
